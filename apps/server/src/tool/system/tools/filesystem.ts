  ...
  return [
    {
      ...
      prompt: "Use this to read an existing file within the workspace.",
      riskTier: 0,
      isReadOnly: true,
      isDestructive: false,
    ...
    },
    {
      ...
      prompt: "Use this to write file contents within the workspace.",
      riskTier: 1,
      isReadOnly: false,
      isDestructive: false,
    ...
    },
    {
      ...
      prompt: "Use this to inspect directory contents within the workspace.",
      riskTier: 0,
      isReadOnly: true,
      isDestructive: false,
      isConcurrencySafe: true,
    ...
    },
    {
      ...
      prompt: "Use this to search file contents within the workspace.",
      riskTier: 0,
      isReadOnly: true,
      isDestructive: false,
      isConcurrencySafe: true,
