...
**Qualification: 0 / 5 tests fully pass today; all five have target paths, with substantial partial substrate in T2–T5.** The project may call itself an Agent OS when T1, T3, and T4 fully pass; until then the honest description is *"an evidence-gated personal workflow engine building toward an Agent OS."*
