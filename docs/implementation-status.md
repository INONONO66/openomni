...
**Source baseline:** #946 stage 2 is rebased onto `f9c02a66` (#991), including #988's protocol contract and #990's desktop gateway selection. Historical #948 receipts below retain their `c4fb7748` source pin. [SLOP](SLOP.md) records deletion ownership; the PR body records the final gate commands and exit codes. Closed issue labels are not implementation evidence.
...
- #949 owns the machine-locus plain-tool door. Continuous alarm scheduling and remaining Wait/approval lifecycle unification stay #947/#969 as detailed above; machine handles and codemode are described above.
