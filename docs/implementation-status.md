...
| Automatic connector/channel read-back invocation during completion gating | 📋 | — | Runtime executor API exists, but dispatch handlers, app connectors, and channel adapters do not yet invoke it automatically while evaluating worker completion reports |
