...
- **Two bundled providers**: `@ai-sdk/anthropic`, `@ai-sdk/openai`. Custom `models.dev` providers without an npm package use the OpenAI provider with their catalog `api` URL as `baseURL`.
