...
import { createOpenAIProvider, OPENAI_MODELS, CODEX_ALLOWED_MODELS, getOpenAIModels } from "../../src/provider"
...
describe("createOpenAIProvider", () => {
  ...
  test("concurrent requests share single token refresh (promise dedup)", async () => {
    ...
    await Promise.all([
      result.customFetch!("https://api.openai.com/v1/responses", { headers: {} }),
      result.customFetch!("https://api.openai.com/v1/responses", { headers: {} }),
      result.customFetch!("https://api.openai.com/v1/responses", { headers: {} }),
    ])
