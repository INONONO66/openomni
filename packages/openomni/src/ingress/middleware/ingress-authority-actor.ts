...
export function getActor(event: Ingress.InboundEvent): ActorRecord | undefined {
...
export function getEventAction(event: Ingress.InboundEvent): WorkerControlAction | undefined {
...
export function targetRequiresCoordinator(target: Ingress.Target): boolean {
  return target.kind !== "resident";
}

export function isAuthorizedTopLevelActor(event: Ingress.InboundEvent): boolean {
