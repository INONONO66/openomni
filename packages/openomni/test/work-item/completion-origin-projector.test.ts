...
describe("completion source origin projection", () => {
  test.each([
    ...
    [{ source: "api", identity: { kind: "external_actor", id: "actor:api" } }, "external_actor"],
    [{ source: "a2a", identity: { kind: "external_actor", id: "actor:a2a" } }, "external_actor"],
    [
      { source: "human", identity: { kind: "external_actor", id: "actor:human" } },
      "external_actor",
    ],
    [{ source: "replay" }, "replay"],
    [{ source: "recovery" }, "recovery"],
    [{ source: "resident", identity: { kind: "resident", id: "resident:primary" } }, "resident"],
