...
export const scriptToolingPartitions = {
  ...
  "scripts-tooling-3": ["quality-mutation-shard.test.ts", "check-census.test.ts", "check-types-census.test.ts", "quality-metrics/declaration-erasure.test.ts", "quality-measure.test.ts", "census-program.test.ts", "quality-ratchet.test.ts", "check-quality-python.test.ts"],
